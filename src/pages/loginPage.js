import Header from '../components/Header/header'; // Importa el componente Header desde la ubicación especificada.
...
import { logIn } from '../redux/actions/authActions'; // Importa la acción logIn desde el archivo authActions en la ubicación especificada.
